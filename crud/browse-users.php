						...
						<div class="row">
							<div class="col-sm-2">
								<div class="form-group">
									...
									<input type="text" name="username" id="username" class="form-control" value="<?php echo isset($_REQUEST['username'])?$_REQUEST['username']:''?>" placeholder="Enter username">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
									<label>Jenis Kelamin</label>
									<input type="text" name="userJk" id="userJk" class="form-control" value="<?php echo isset($_REQUEST['userJk'])?$_REQUEST['userJk']:''?>" placeholder="Enter jenis kelamin">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
									<label>Prodi</label>
									<input type="tel" name="userprodi" id="userprodi" class="form-control" value="<?php echo isset($_REQUEST['userprodi'])?$_REQUEST['userprodi']:''?>" placeholder="Enter Prodi">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="edit-users.php?editId=<?php echo $val['id'];?>" class="text-succes"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
							<a href="delete.php?delId=<?php echo $val['id'];?>" class="text-secondary" onClick="return confirm('Are you sure to delete this user?');"><i class="fa fa-fw fa-trash"></i> Delete</a> |
							<a href="read.php?readId=<?php echo $val['id'];?>" class="text-dark"> Read</a>
						</td>
					</tr>
					<?php } ?>
				</tbody>
